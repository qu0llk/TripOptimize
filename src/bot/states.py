...
class StateMachine(StatesGroup):
    ...
    # Подцикл дней: после ввода названия города бот ждёт именно дней.
    # Отдельное состояние нужно, чтобы текст «3» или «⏭ Пропустить» не
    # воспринимался как имя следующего города.
    waiting_for_intermediate_days = State()
